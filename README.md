...
This repository contains curriculum, exercises, assignments, and sample solutions
for the Full-Stack Web Development workshop conducted at CodeRush.
...
- 06 - Databases(PostgreSQL)
- 07 - Django / Django API
- 08 - React
- 09 - Full Stack Apps
- 10 - Deployment
- 11 - AI integration
...
- Develop a REST API with React and Django API
- Connect frontend with backend  
- Work with OpenAI, Hugging Face API 
...
| Student Name | Project Name | Tools Used | GitHub / Links | Other Links |
|--------------|-------------|------------|----------------|-------------|
| Subekshya Subedi | Smart Study Planner | Django, React | https://github.com/subekshya-s/Smart_Study_Planner | - |
| Anuja Khatri | ChatGPT Clone | HTML, CSS, JS, Bootstrap | https://github.com/Anujakhatri/chatgpt_clone | - |
...
| Subhikshya Shrestha | Hotel Booking System | HTML, CSS, JS | https://github.com/subhikshyashrestha/hotel-booking-system | - |
| Kopila Devkota | Weather Dashboard | React, Tailwind | https://github.com/kopiladevkota/weather-app-dashboard | - |
...
- 30+ real-world student projects delivered  
- Full-stack applications with React + Django  
- Python automation tools published on PyPI  
- End-to-end deployment experience (Render, Vercel)  
